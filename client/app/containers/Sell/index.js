  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h3 className='text-uppercase'>Become A Rudderstack store Seller!</h3>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Would you like to sell your products on Rudderstack store!</h3>
                  <h5>Grow your business with Rudderstack store</h5>
                  <b>Apply Today</b>
                </div>
              </Col>
